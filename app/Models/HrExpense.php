...
class HrExpense extends Model
{
    ...
    public function getdatatable($fillterdata)
    {
        ...
        $columns = array(
            ...
            5 => DB::raw('MONTHNAME(CONCAT("2023-", hr_expense.month, "-01"))'), DB::raw('DATE_FORMAT(hr_expense.date, "%d-%b-%Y")')
        );
    ...
    public function getHrExpenseDatatable($fillterdata)
    {
        $requestData = $_REQUEST;
        $columns = array(
            0 => 'hr_expense.id',
