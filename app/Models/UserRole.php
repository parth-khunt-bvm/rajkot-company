...
class UserRole extends Model
{
    ...
    public function getdatatable()
    {
        ...
        foreach ($resultArr as $row) {
            ...
            if(Auth()->guard('admin')->user()->is_admin == 'Y' || in_array(11, explode(',', $permission_array[0]['permission'])) )
            ...
            if(Auth()->guard('admin')->user()->is_admin == 'Y' || in_array(9, explode(',', $permission_array[0]['permission'])) ){
         ...
         if(Auth()->guard('admin')->user()->is_admin == 'Y' || in_array(10, explode(',', $permission_array[0]['permission'])) )
