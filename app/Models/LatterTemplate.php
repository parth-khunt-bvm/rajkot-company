...
class LatterTemplate extends Model
{
    ...
    public function getdatatable()
    {
        ...
        foreach ($resultArr as $row) {
            ...
            if(Auth()->guard('admin')->user()->is_admin == 'Y' || in_array(144, explode(',', $permission_array[0]['permission'])) ){
                if ($row['status'] == 'A') {
            ...
            if(Auth()->guard('admin')->user()->is_admin == 'Y' || in_array(145, explode(',', $permission_array[0]['permission'])) )
