    ...
    public function ajaxcall(Request $request){
        ...
        switch ($action) {
            ...
            case 'get_emp_attendance_list':
                ...
                // $list = $objAttendance->get_attendance_details_by_employee($request->input('data'));
                // $list = $objAttendance->get_attendance_details_by_employee($data['userId'],  $data['month'], $data['year']);
                $list = $objAttendance->get_attendance_details_by_employee('2',  '2', '2024');
