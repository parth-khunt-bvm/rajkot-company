var Manager = function(){
    var list = function(){
        ...
        var arrList = {
            'tableID': '#admin-manager-list',
            'ajaxURL': baseurl + "admin/manager/ajaxcall",
    ...
    var addManager = function(){
        ...
        var message = {
            ...
            manager_name: {required: 'Please enter manager name'},
            status: {required: "Please select admin manager status",},
        }
