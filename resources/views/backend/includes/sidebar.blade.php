            ...
            <ul class="menu-nav">
                ...
                <li class="menu-item  {{ ( $currentRoute  ==  "admin.technology.list" || $currentRoute  ==  "admin.technology.add" || $currentRoute  ==  "admin.technology.edit"    ? 'menu-item-active' : '' ) }}" aria-haspopup="true">
                    <a href="{{ route('admin.technology.list') }}" class="menu-link">
                        ...
                        <span class="menu-text">Technology List</span>
                    </a>
                </li>
                {{-- Technology Menu End --}}

                {{-- salary Menu --}}
                    {{-- <li class="menu-item  {{ ( $currentRoute  ==  "admin.salary.list" || $currentRoute  ==  "admin.salary.add" || $currentRoute  ==  "admin.salary.edit"    ? 'menu-item-active' : '' ) }}" aria-haspopup="true">
