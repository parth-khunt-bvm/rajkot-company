        ...
        <div class="card card-custom gutter-b">
            <div class="card-header flex-wrap py-3">
                <div class="card-title">
                    ...
                    <span class="svg-icon svg-icon-primary svg-icon-2x show-hr-expense-filter" id="show-hr-expense-filter"><!--begin::Svg Icon | path:C:\wamp64\www\keenthemes\themes\metronic\theme\html\demo1\dist/../src/media/svg/icons\Text\Filter.svg--><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                ...
                <div class="card-toolbar">
                   ...
                   @endif
                    ...
                    @if(Auth()->guard('admin')->user()->is_admin == 'Y' || in_array(67, explode(',', $permission_array[0]['permission'])) )
                   ...
                   <a href="{{ route('admin.hr.expense.deleted') }}" class="btn btn-primary font-weight-bolder">Trash Data</a>
                    <!--end::Button-->
                </div>

            </div>
            <div class="card-body">
                <form class="form" style="display: none" id="add-hr-expense" method="POST" action="{{ route('admin.hr.expense.save-add-expense') }}" autocomplete="off">@csrf
                    <div class="row">
                        <div class="col-md-2">
                        ...
                        <div class="col-md-2">
                            <div class="form-group mt-8">
                                ...
                                <button type="reset" class="btn btn-secondary"><a href="{{route('admin.hr.expense.list')}}">Cancel</a></button>
                            </div>
                        </div>
                    </div>
                </form>
                ...
                <div class="expense-list">
                    <!--begin: Datatable-->
                    <table class="table table-bordered table-checkable" id="hr-expense-list">
                        <thead>
                            <tr>
                                <th>#</th>
                                <th>Date</th>
