        ...
        <div class="container-fluid">
            ...
            <div class="card card-custom gutter-b">
                <div class="card-header flex-wrap py-3">
                    ...
                    <div class="card-toolbar">
                        ...
                        @if (Auth()->guard('admin')->user()->is_admin == 'Y' || in_array(147, explode(',', $permission_array[0]['permission'])))
                            <button class="btn btn-primary font-weight-bolder mr-5 show-latter-abbreviation-form"
                                id="show-latter-abbreviation-form">+</button>
                        @endif
                ...
                <div class="card-body">
                    ...
                    <form class="form" style="display: none;" id="add-latter-abbreviations" method="POST"
                        action="{{ route('latter-abbreviations.store') }}" autocomplete="off">@csrf
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="key" class="form-control" placeholder="Enter key name"
                                        autocomplete="off">
                                </div>
                            </div>
                            <div class="col-md-4">
