                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control input-name" id="" cols="30" rows="1" name="address" id="address" autocomplete="off"></textarea>
                                            <span class="type_error text-danger"></span>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" id="" cols="30" rows="5" name="trainee_performance" id="trainee_performance" autocomplete="off"></textarea>
                                        </div>
                                    </div>
                                    <div class="col-xl-3">
                                        <div class="form-group">
