    ...
    <div class="wizard wizard-3" id="kt_wizard_v3" data-wizard-state="step-first" data-wizard-clickable="true">
        ...
        <div class="row py-10 px-8 py-lg-12 px-lg-17">
            <div class="col-xl-12 col-xxl-12">
                <!--begin: Wizard Form-->
                <form action="{{ route('admin.employee.save-add-employee') }}" method="POST" enctype="multipart/form-data" class="form add-employee" id="kt_form">
                    @csrf
                    <!--begin: Wizard Step 1-->
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control date_of_birth" name="dob" id="dob" max="{{ date('Y-m-d') }}" placeholder="Date Of Birth" autocomplete="off" />
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-xl-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control datepicker_date" name="doj" id="doj" placeholder="Date Of Joining" autocomplete="off" />
                                </div>
                            </div>
                            <div class="col-xl-6">
                                <div class="form-group">
                                    ...
                                    <input type="email" class="form-control" name="gmail" id="gmail" placeholder="Gmail" autocomplete="off" />
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-xl-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="gmail_password" id="gmail_password" placeholder="Gmail Password" autocomplete="off" />
                                </div>
                            </div>
                            <div class="col-xl-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="slack_password" id="slack_password" placeholder="Slack Password" autocomplete="off" />
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-xl-6">
                                <div class="form-group">
                                    ...
                                    <input type="email" class="form-control" name="personal_email" id="personal_email" placeholder="Personal Email" autocomplete="off" />
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="acc_holder_name" id="acc_holder_name" placeholder="Account Holder Name" autocomplete="off" />
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-xl-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" name="account_number" id="account_number" placeholder="Account Number" autocomplete="off" />
                                </div>
                            </div>
                            <div class="col-xl-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="ifsc_code" id="ifsc_code" placeholder="IFSC Code" autocomplete="off" />
                                </div>
                            </div>
                        </div>
                        <div class="row">
                        ...
                        <div class="row">
                            <div class="col-xl-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="parent_name" id="parent_name" placeholder="Parent Name" autocomplete="off" />
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" id="" cols="30" rows="10" name="address" id="address" autocomplete="off"></textarea>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-xl-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" name="experience" id="experience" placeholder="Experience" autocomplete="off" />
                                </div>
                            </div>
                            <div class="col-xl-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="hired_by" id="hired_by" placeholder="Hired By" autocomplete="off" />
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-xl-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" name="salary" id="salary" placeholder="Salary" autocomplete="off" />
                                </div>
                            </div>
                            <div class="col-xl-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control datepicker_date" name="stipend_from" id="stipend_from" placeholder="Stippend From" autocomplete="off" />
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-xl-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control datepicker_date" name="bond_last_date" id="bond_last_date" placeholder="Bond Last Date" autocomplete="off" />
                                </div>
                            </div>
                            <div class="col-xl-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control datepicker_date" name="resign_date" id="resign_date" placeholder="Resign Date" autocomplete="off" />
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-xl-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control datepicker_date" name="last_date" id="last_date" placeholder="Last Date" autocomplete="off" />
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" id="" cols="30" rows="10" name="trainee_performance" id="trainee_performance" autocomplete="off"></textarea>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="card card-custom gutter-b example example-compact">
                    ...
                    <div class="card-body p-0">
                        <!--begin: Wizard-->
                        <form id="add-employee-form" action="{{  route('admin.employee.save-add-employee') }}" method="post" enctype="multipart/form-data" class="form">
                            @csrf
                            <!-- Step 1 -->
                                ...
                                <div class="row">
                                    <div class="col-xl-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control input-name" name="first_name" id="first_name" placeholder="First Name" autocomplete="off" />
                                    ...
                                    <div class="col-xl-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control input-name" name="last_name" id="last_name" placeholder="last Name" autocomplete="off" />
                                            <span class="type_error text-danger"></span>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xl-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control input-name" name="slack_password" id="slack_password" placeholder="Slack Password" autocomplete="off" />
                                            <span class="type_error text-danger"></span>
                                        </div>
                                    </div>
                                </div>
