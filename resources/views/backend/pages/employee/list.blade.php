        ...
        <div class="card card-custom gutter-b">
            <div class="card-header flex-wrap py-3">
                <div class="card-title">
                    ...
                    <span class="svg-icon svg-icon-primary svg-icon-2x show-employee-filter" id="show-employee-filter">
                                    ...
                                    <div class="col-md-6">
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label>Status</label>
                                                    <select class="form-control select2 supplier_status supplier-filter change-fillter" id="status_id" name="supplier_status">
