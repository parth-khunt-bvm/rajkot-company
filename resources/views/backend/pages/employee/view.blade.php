                                        ...
                                        <div class="card-body pt-4">
                                            ...
                                            <div class="navi navi-bold navi-hover navi-active navi-link-rounded">
                                                <div class="navi-item mb-2">
                                                    <a href="#personal-information" class="navi-link py-4 active personal" data-personal-info="{{ $employee_details->id }}" >
                                                ...
                                                <div class="navi-item mb-2">
                                                    <a href="#"  class="navi-link py-4 bank" data-bank-info="{{ $employee_details->id }}">
                                                        <span class="navi-icon mr-2">
                                                            <span class="svg-icon">
                                                ...
                                                <div class="navi-item mb-2">
                                                    <a href="#" class="navi-link py-4 parent" data-parent-info="{{ $employee_details->id }}">
                                                        <span class="navi-icon mr-2">
                                                            <span class="svg-icon">
                                                                <!--begin::Svg Icon | path:assets/media/svg/icons/Code/Compiling.svg-->
                                                                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                                ...
                                                <div class="navi-item mb-2">
                                                    <a href="#" class="navi-link py-4 company" data-company-info="{{ $employee_details->id }}">
                                                        <span class="navi-icon mr-2">
                                                            <span class="svg-icon">
                                                                <!--begin::Svg Icon | path:assets/media/svg/icons/Code/Compiling.svg-->
                                                                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
