        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <address class="text-end">
                    ...
                    Mobile Number: +91 70694 59872<br>
                    Date: {{ $date }}
                </address>
            </div>
            <div class="col-md-12">
                ...
                <p>We are starting with a probationary period of two months starting from the date of your joining. However, this period can be cut short or extended based on the individual’s performance and at the discretion of the management. Your pay during the probation period will be Rs. {{ $salary }}/- per month.</p>
