...
@php
   $month= ["","January","February","March","April","May","June","July","August","September","October","November","December"];
    ...
    $lop = number_format($grossEarnings, 0, ',', ',') / $salary_slip_details['working_day'] * $salary_slip_details['loss_of_pay'];
        ...
        <td align="left" style="width: 100%!important;">
            <table>
                ...
                <tr>
                    ...
                    <td style="margin-top: 10px !important;padding-top: 10px !important; font-size: 14px!important;">
                        : {{ date_formate($salary_slip_details['pay_date']) }}</td>
                </tr>
            ...
            <table style="width: 95% !important;">
                <tr>
                    ...
                    <td style="text-align: right !important; font-weight: bold;"><span
                            style="font-family: DejaVu Sans; sans-serif;">&#8377;</span>{{ $salary_slip_details['basic_salary']}}
                    </td>
                </tr>
            </table>
        </td>
        <td>
            <table style="width: 100% !important;">
                <tr>
                    ...
                    <td style="text-align: right !important; font-weight: bold;"><span
                            style="font-family: DejaVu Sans; sans-serif;">&#8377;</span>{{ $salary_slip_details['income_tax']}}
                    </td>
                </tr>
            </table>
        </td>
        ...
        <td style="text-align: left !important">
            <table style="width: 95% !important;">
                <tr>
                    ...
                    <td style="text-align: right !important; font-weight: bold;"><span
                            style="font-family: DejaVu Sans; sans-serif;">&#8377;</span>{{ $salary_slip_details['house_rent_allow']}}
                    </td>
                </tr>
            </table>
        </td>
        <td>
            <table style="width: 100% !important;">
                <tr>
                    ...
                    <td style="text-align: right !important; font-weight: bold;"><span
                            style="font-family: DejaVu Sans; sans-serif;">&#8377;</span>{{ $salary_slip_details['pf']}}
                    </td>
                </tr>
            </table>
        </td>
        ...
        <td>
            <table style="width: 100% !important;">
                <tr>
                    ...
                    <td style="text-align: right !important; font-weight: bold;"><span
                            style="font-family: DejaVu Sans; sans-serif;">&#8377;</span>{{ $salary_slip_details['pt']}}
                    </td>
                </tr>
            </table>
        </td>
