        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="card card-custom gutter-b example example-compact">
                    ...
                    <!--begin::Form-->
                    <form class="form" id="edit-salary-slip" method="POST" action="{{ route('admin.employee-salaryslip.save-edit-employee-salaryslip') }}">@csrf
                        <div class="card-body">
                            <div class="col-12">
                                <h3 class="card-title">EMPLOYEE DETAILS</h3>
                            </div>
                            <div class="col-12">
                                <input type="hidden" name="salary_slip_id"  class="form-control" value="{{ $salary_slip_details->id}}">
                                <div class="row">
                                    <div class="col-4">
                                            ...
                                            <select class="form-control employee-change select2" id="empDepartment" name="empDepartment">
                                                <option value="">Select Employee Department</option>
                                                 @foreach ($technology  as $key => $value )
                                                    <option value="{{ $value['id'] }}" {{ $value['id'] == $salary_slip_details->department ? 'selected="selected"' : '' }}>{{ $value['technology_name'] }}</option>
                                                 @endforeach
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-4">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control employee-change select2" name="empDesignation" id="empDesignation">
                                                ...
                                                <option value="{{ $value['id'] }}" {{ $value['id'] == $salary_slip_details->designation ? 'selected="selected"' : '' }}>{{ $value['designation_name'] }}</option>
                                                 @endforeach
                                            </select>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-4">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control select2" name="month" id="salarySlipMonthId">
                                                ...
                                                <option value="3" {{ $salary_slip_details->month == 3 ? 'selected="selected"' : '' }}>March</option>
                                                <option value="4" {{ $salary_slip_details->month == 4 ? 'selected="selected"' : '' }}>April</option>
                                                <option value="5" {{ $salary_slip_details->month == 5 ? 'selected="selected"' : '' }}>May</option>
                                                <option value="6" {{ $salary_slip_details->month == 6 ? 'selected="selected"' : '' }}>June</option>
                                                <option value="7" {{ $salary_slip_details->month == 7 ? 'selected="selected"' : '' }}>July</option>
                                                <option value="8" {{ $salary_slip_details->month == 8 ? 'selected="selected"' : '' }}>August</option>
                                                <option value="9" {{ $salary_slip_details->month == 9 ? 'selected="selected"' : '' }}>September</option>
                                                <option value="10" {{ $salary_slip_details->month == 10 ? 'selected="selected"' : '' }}>October</option>
                                                <option value="11" {{ $salary_slip_details->month == 11 ? 'selected="selected"' : '' }}>November</option>
                                                <option value="12" {{ $salary_slip_details->month == 12 ? 'selected="selected"' : '' }}>December</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-4">
                                    ...
                                    <div class="col-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control datepicker_date" name="pay_salary" value="{{ date_formate($salary_slip_details->pay_salary_date)  }}" placeholder="Please enter your Pay Salary date" autocomplete="off" />
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    <div class="col-4">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control " type="number" id="basic" value="{{ $salary_slip_details->basic_salary }}" name="basic">
                                        </div>
                                    </div>
                                    <div class="col-4">
                                        <div class="form-group">
                                            <label class="" for="exampleSelect1">WORKING DAY <span class="text-danger">*</span></label>
                                            <input class="form-control " type="number" id="wd" value="{{ $salary_slip_details->working_day }}" name="wd">
                                        </div>
                                    </div>
                                    <div class="col-4">
                                        <div class="form-group">
                                            <label class="" for="exampleSelect1">Loss Of Pay(LOP) <span class="text-danger">*</span></label>
                                            <input class="form-control " type="number" id="lop" value="{{ $salary_slip_details->loss_of_pay }}" name="lop">
                                        </div>
                                    </div>
                                </div>
                            </div>
