        ...
        <div class="card card-custom gutter-b">
            <div class="card-header flex-wrap py-3">
                <div class="card-title">
                    ...
                    <span class="svg-icon svg-icon-primary svg-icon-2x show-social-media-post-filter" id="show-social-media-post-filter">
                ...
                <div class="card-toolbar">
                    ...
                    <button class="btn btn-primary font-weight-bolder mr-5 show-social-media-post-form" id="show-social-media-post-form">+</button>
                    @endif

                    @if(Auth()->guard('admin')->user()->is_admin == 'Y' || in_array(121, explode(',', $permission_array[0]['permission'])) )
                    <button data-toggle="modal" data-target="#import-social-media-post" class="import-social-media-post btn btn-danger font-weight-bolder mr-5 ">Import Post</button>
                    @endif

                    @if(Auth()->guard('admin')->user()->is_admin == 'Y' || in_array(122, explode(',', $permission_array[0]['permission'])) )
                        <a href="{{ route('admin.social-media-post.create') }}" class="btn btn-primary font-weight-bolder">
            ...
            <div class="card-body">
                ...
                <form class="form" style="display: none" id="add-social-media-post" method="POST" action="{{ route('admin.social-media-post.store') }}">@csrf
                    <div class="row">
                        <div class="col-md-2">
                        ...
                        <div class="col-md-2">
                            <div class="form-group">
                                <label>Post Detail <span class="text-danger">*</span></label>
                                <input type="text" name="post_detail" class="form-control" placeholder="Enter post detail" autocomplete="off">
                            </div>
                        </div>
                        <div class="col-md-2">
                            <div class="form-group">
                ...
                @if(Auth()->guard('admin')->user()->is_admin == 'Y' || in_array(120, explode(',', $permission_array[0]['permission'])) )
                <div class="row social-media-post-filter" style="display: none">
                    <div class="col-md-10">
                        <div class="row">
                            <div class="col-md-3">
                                <div class="form-group">
                ...
                <div class="social-media-post-list-div">
                    <!--begin: Datatable-->
