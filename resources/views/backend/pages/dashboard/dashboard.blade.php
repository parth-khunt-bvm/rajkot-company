                    ...
                    <div class="row">
                        <div class="px-6 py-8 mb-7 tiles-bg-color col-3">
                            ...
                            <a href="{{ route('admin.attendance.day-list', ['date' => $date]) }}"
                                class=" font-weight-bold font-size-h6">Employee
                        ...
                        <div class="px-6 py-8 mb-7 tiles-bg-color col-3">
                            ...
                            <a href="{{ route('admin.attendance.day-list', ['date' => $date]) }}"
                                class=" font-weight-bold font-size-h6">Present
                        ...
                        <div class="px-6 py-8 mb-7 tiles-bg-color col-3">
                            ...
                            <a href="{{ route('admin.attendance.day-list', ['date' => $date]) }}"
                                class="text-danger font-weight-bold font-size-h6 mt-2">Half Day
                    ...
                    <div class="row">
                        ...
                        <div class="px-6 py-8 mb-7 tiles-bg-color col-3">
                            ...
                            <a href="{{ route('admin.employee.birthday.list') }}"
                                class="text-warning font-weight-bold font-size-h6">Birthday
                            ...
                            <div class="tab-content mt-5" id="myTabTables11">
                                ...
                                <div class="tab-pane fade show active" id="kt_tab_pane_11_3" role="tabpanel"
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-bordered table-checkable" id="dash-employee-birthday-list">
                                            <thead>
                                                <tr>
                                                    <th>#</th>
                                                    <th>Birth Date</th>
