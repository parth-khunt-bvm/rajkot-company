            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="card card-custom gutter-b example example-compact">
                        ...
                        <!--begin::Form-->
                        <form class="form" id="update-profile" method="POST" action="{{ route('save-profile') }}"
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="first_name" class="form-control"
                                                placeholder="Enter your full name first name"
                                                value="{{ $data['first_name'] }}" autocomplete="off">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="last_name" class="form-control"
                                                placeholder="Enter your full name last name"
                                                value="{{ $data['last_name'] }}" autocomplete="off">
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
