...
<div class="d-flex flex-column flex-root">
    ...
    <div class="login login-5 login-signin-on d-flex flex-row-fluid" id="kt_login">
        <div class="d-flex flex-center bgi-size-cover bgi-no-repeat flex-row-fluid" style="background-image: url(http://localhost/hari_om_gunj/public/upload/systemsetting/default.jpg)">
            <div class="login-form   p-7 position-relative overflow-hidden" style="background: white !important; color: black">
                ...
                <div class="login-signin">
                    <div class="mb-10 text-center">
                        <h1 style="font-size: 3rem !important">My Login</h1>
                    ...
                    <form class="form" id="employee-login-form" method="POST" action="auth-employee-login" novalidate="novalidate">
                        @csrf
                        {{-- <input type="hidden" name="_token" value="RwEk0YE8svgPFweTToYmVxQI6iKSmpZt57yNNa0N"> --}}
                        <div class="form-group">
                            <input class="form-control form-control-solid  py-7 px-6" type="text" name="emp_email" placeholder="Please enter your register email" autocomplete="off">
                        </div>
                        <div class="form-group">
                            <input class="form-control form-control-solid  py-7 px-6" type="password" name="emp_password" placeholder="Please enter your password" autocomplete="off">
                        </div>
                        <hr>
